...
class LandlordsControllerTest < ActionController::TestCase
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post :create, landlord: { address: @landlord.address, email: @landlord.email, name: @landlord.name, phone: @landlord.phone }
    end
  ...
  test "should update landlord" do
    patch :update, id: @landlord, landlord: { address: @landlord.address, email: @landlord.email, name: @landlord.name, phone: @landlord.phone }
    assert_redirected_to landlord_path(assigns(:landlord))
  end
